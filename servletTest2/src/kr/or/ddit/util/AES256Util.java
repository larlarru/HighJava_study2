...
public class AES256Util {
	...
	//		==> 암호화를 할 때 다른 랜덤 비트열ㅇ르 이용하는 것이 보통이다.
	...
	private static final String key = "a1b2c3d4e5f6g7h8";	// 암호화 키값(16글자 이상), 임의로 한 값이다.
	...
	public AES256Util() throws UnsupportedEncodingException {
		...
		System.arraycopy(b, 0, keyBytes, 0, len);	// b의 0번째부터 keyBytes의 0번째부터 len까지 붙여라?
	...
	public String encrypt(String str) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, UnsupportedEncodingException {
		...
		// 패딩 : Padding ==> 마지막 블록이 블록의 길이와 항상 딱 맞아 떨이지지 않을 수 있기 때문에
		...
		// 옵션 종류 : ENCRYPT_MODE(암호화모드), DECRYPT_MODE(복화모드)
		//			WRAP_MODE(암호키를 캡술화), UNWRAP_MODE(암호키 캡술화 해제)
