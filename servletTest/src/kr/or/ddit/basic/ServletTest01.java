 ...
 * 
 * 전체 요청 URL주소 ==> http://localhost:80/servletTest/servletTest01.db
 * - http 				==> 프로토콜
 * - localhost			==> 컴퓨터이름 또는 도메인명 또는 IP주소
 * - 80					==> PORT번호(웹은 80번일 경우에는 생략 가능)
 * - /servletTest 		==> 컨텍스트패스(보통 '프로젝트이름'으로 지정된다.)
 * - /servletTest01.do	==> 서블릿 요청 URL패턴
 * 
 */

// 이 예제는 배포서술자(DO, Deployment Descriptor ==> web.xml)를 이용해서
